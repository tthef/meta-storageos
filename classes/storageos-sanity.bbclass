# Provide some extensions to sanity.bbclass to handle storageos-specific conf file upgrades

python storageos_update_bblayersconf() {
...
BBLAYERS_CONF_UPDATE_FUNCS =+ "storageos_update_bblayersconf"
